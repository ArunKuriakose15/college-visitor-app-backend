...
const AddVisitor = () => {
    ...
    const readValues = () => {
        console.log(input)
        axios.post("http://localhost:3001/api/visitor/add", input).then((response) => {
                    ...
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        ...
                        <div className="row g-3">
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <input type="number" className="form-control" name="vistorPhone" value={input.vistorPhone} onChange={inputHandler} />
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <input type="number" className="form-control" name="vistorAadhar" value={input.vistorAadhar} onChange={inputHandler} />
